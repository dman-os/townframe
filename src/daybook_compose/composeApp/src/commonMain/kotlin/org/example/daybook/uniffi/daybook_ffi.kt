...
internal object IntegrityCheckingUniffiLib {
    ...
    external fun uniffi_daybook_ffi_checksum_method_globalffictx_get_repo_config(
    ): Short
    external fun uniffi_daybook_ffi_checksum_method_globalffictx_is_repo_usable(
    ): Short
    external fun uniffi_daybook_ffi_checksum_method_globalffictx_register_repo_path(
    ): Short
    ...
    external fun uniffi_daybook_ffi_checksum_constructor_globalffictx_init(
    ): Short
...
external fun uniffi_daybook_ffi_fn_constructor_ffictx_init(`repoRoot`: RustBuffer.ByValue,`gcx`: Long,
): Long
...
external fun uniffi_daybook_ffi_fn_clone_globalffictx(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Long
external fun uniffi_daybook_ffi_fn_free_globalffictx(`handle`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Unit
external fun uniffi_daybook_ffi_fn_constructor_globalffictx_init(
): Long
external fun uniffi_daybook_ffi_fn_method_globalffictx_get_repo_config(`ptr`: Long,
): Long
external fun uniffi_daybook_ffi_fn_method_globalffictx_is_repo_usable(`ptr`: Long,`repoRoot`: RustBuffer.ByValue,
): Long
external fun uniffi_daybook_ffi_fn_method_globalffictx_register_repo_path(`ptr`: Long,`repoRoot`: RustBuffer.ByValue,
): Long
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_daybook_ffi_checksum_method_globalffictx_get_repo_config() != 5328.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_daybook_ffi_checksum_method_globalffictx_is_repo_usable() != 46509.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_daybook_ffi_checksum_method_globalffictx_register_repo_path() != 10379.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_daybook_ffi_checksum_constructor_ffictx_init() != 24715.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_daybook_ffi_checksum_constructor_globalffictx_init() != 48872.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class FfiCtx: Disposable, AutoCloseable, FfiCtxInterface
{
    ...
    @Throws(FfiException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
     suspend fun `init`(`repoRoot`: kotlin.String, `gcx`: GlobalFfiCtx) : FfiCtx {
        return uniffiRustCallAsync(
        UniffiLib.uniffi_daybook_ffi_fn_constructor_ffictx_init(FfiConverterString.lower(`repoRoot`),FfiConverterTypeGlobalFfiCtx.lower(`gcx`),),
        { future, callback, continuation -> UniffiLib.ffi_daybook_ffi_rust_future_poll_u64(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_daybook_ffi_rust_future_complete_u64(future, continuation) },
        { future -> UniffiLib.ffi_daybook_ffi_rust_future_free_u64(future) },
        // lift function
...
public interface GlobalFfiCtxInterface {
...
open class GlobalFfiCtx: Disposable, AutoCloseable, GlobalFfiCtxInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_daybook_ffi_fn_free_globalffictx(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_daybook_ffi_fn_clone_globalffictx(handle, status)
        }
    }
    ...
    override suspend fun `getRepoConfig`() : RepoConfig {
        return uniffiRustCallAsync(
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_daybook_ffi_fn_method_globalffictx_get_repo_config(
                uniffiHandle,
    ...
    override suspend fun `isRepoUsable`(`repoRoot`: kotlin.String) : kotlin.Boolean {
        return uniffiRustCallAsync(
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_daybook_ffi_fn_method_globalffictx_is_repo_usable(
                uniffiHandle,
    ...
    override suspend fun `registerRepoPath`(`repoRoot`: kotlin.String) : KnownRepoEntry {
        return uniffiRustCallAsync(
        callWithHandle { uniffiHandle ->
            UniffiLib.uniffi_daybook_ffi_fn_method_globalffictx_register_repo_path(
                uniffiHandle,
                FfiConverterString.lower(`repoRoot`),
            )
        },
    ...
    @Throws(FfiException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
     suspend fun `init`() : GlobalFfiCtx {
        return uniffiRustCallAsync(
        UniffiLib.uniffi_daybook_ffi_fn_constructor_globalffictx_init(),
        { future, callback, continuation -> UniffiLib.ffi_daybook_ffi_rust_future_poll_u64(future, callback, continuation) },
        { future, continuation -> UniffiLib.ffi_daybook_ffi_rust_future_complete_u64(future, continuation) },
        { future -> UniffiLib.ffi_daybook_ffi_rust_future_free_u64(future) },
        // lift function
        { FfiConverterTypeGlobalFfiCtx.lift(it) },
        // Error FFI converter
        FfiException.ErrorHandler,
    )
    }
 ...
 * @suppress
 */
public object FfiConverterTypeGlobalFfiCtx: FfiConverter<GlobalFfiCtx, Long> {
    override fun lower(value: GlobalFfiCtx): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): GlobalFfiCtx {
        return GlobalFfiCtx(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): GlobalFfiCtx {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: GlobalFfiCtx) = 8UL

    override fun write(value: GlobalFfiCtx, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
